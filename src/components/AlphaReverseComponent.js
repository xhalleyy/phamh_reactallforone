...
import { alphaReverseApi } from '../services/DataService.js';
        ...
        <div className='gameBG'>
            ...
            <div className="hidden lg:block">
                <div className="inline-block bg-customBlue2 ps-5 pe-9 py-1 mt-16 ms-16 rounded-md">
                    <h1 className="font-hiromisake text-6xl xl:text-7xl text-white">Reverse It (Alphanumeric)</h1>
                </div>
            </div>
            ...
            <div className="block lg:hidden">
                <div className="inline-flex bg-customBlue2 ps-5 pe-9 py-1 mt-12 rounded-md">
                    <h1 className="font-hiromisake text-5xl md:text-6xl text-white">Reverse It<br />
            ...
            <div className="grid lg:grid-cols-2">
                <div className="lg:col-span-1 lg:ms-20 lg:mt-24 mt-10 ms-10">
                    <p className="text-white font-nova lg:text-2xl text-xl pb-1" style={{ lineHeight: '1.4rem' }}>Enter a sequence of
                        <br /> numbers and letters</p>
                    <input onChange={(e) => setInput(e.target.value)} id="sequenceinput" type="text" className="rounded-sm lg:text-2xl text-xl" />
                    <br />
                ...
                <div className="static">
                    <div className="grid grid-cols-3">
                        ...
                        <div className="col-span-1 flex justify-end me-5">
                            <a href="numReverse"
                                className="bg-customLightP rounded-lg px-3 py-1 text-2xl text-white font-nova flex items-center drop-shadow-xl">Next <span className='text-2xl ps-2'>&gt;</span></a>
                        </div>
                    </div>
                </div>
            </div>
