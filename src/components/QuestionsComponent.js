...
import { questionsApi } from '../services/DataService.js';
        ...
        <div className='gameBG'>
            ...
            <div className="hidden lg:block">
                <div className="inline-block bg-customBlue2 ps-5 pe-9 py-1 mt-16 ms-16 rounded-md">
                    <h1 className="font-hiromisake text-7xl text-white">Asking Questions</h1>
                </div>
            </div>
            ...
            <div className="block lg:hidden">
                <div className="inline-flex bg-customBlue2 ps-5 pe-9 py-1 mt-12 rounded-md">
                    <h1 className="font-hiromisake text-5xl md:text-6xl text-white">Asking <br />Questions</h1>
                </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2">
                <div className="lg:col-span-1 lg:ms-20 lg:mt-24 mt-10 ms-10">
                    ...
                    <br />
                    <p className="text-white font-nova lg:text-2xl text-xl pt-2 pb-1" style={{lineHeight: '1.4rem'}}>Enter the time you <br />woke up</p>
                    <input onChange={(e) => setTime(e.target.value)} id="timeinput" type="text" className="rounded-sm lg:text-2xl text-xl" />
                    <br />
