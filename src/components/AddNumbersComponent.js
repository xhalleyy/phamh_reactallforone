...
import { summationApi } from '../services/DataService.js';
        ...
        <div className='gameBG'>
            ...
            <div className="hidden lg:block">
                <div className="inline-block bg-customBlue2 ps-5 pe-9 py-1 mt-16 ms-16 rounded-md">
                    <h1 className="font-hiromisake text-7xl text-white">Summation</h1>
                </div>
            </div>
            ...
            <div className="block lg:hidden">
                <div className="inline-block bg-customBlue2 ps-5 pe-9 py-1 mt-12 rounded-md">
                    <h1 className="font-hiromisake text-5xl md:text-6xl text-white">Summation</h1>
                </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2">
                <div className="lg:col-span-1 lg:ms-20 lg:mt-24 mt-16 ms-10">
                    ...
                    <br />
                    <p className="text-white font-nova lg:text-2xl text-xl pt-2">Enter the second number</p>
                ...
                <div className="lg:col-span-1 sm:col-span-2 place-self-center lg:mt-40 lg:mb-0 lg:mx-0 mx-10 mt-16">
                    <div className="bg-customPurple/70 rounded-lg lg:me-28 text-2xl lg:text-5xl">
            ...
            <div className="static hidden md:block">
                <div className="grid grid-cols-2">
                    <div className="absolute bottom-0 left-0 ms-16 mb-10">
                        ...
                        <p
                            className="rounded-lg mx-3 my-4 text-3xl opacity-0 font-nova flex items-center justify-center drop-shadow-xl">Home
                        </p>
                    </div>
                ...
                <div className="static">
                    <div className="grid grid-cols-3">
                        ...
                        <div className="col-span-1 flex justify-center">
                            <button
                                className="bg-customGreen rounded-lg px-4 py-1 text-2xl text-white font-nova inline-block justify-center items-center drop-shadow-xl">
                                <Link to='/'>
                                    Home
                                </Link>
                            </button>
                        ...
                        <div className="col-span-1 flex justify-end me-5">
                            <a href='questions' className="bg-customLightP rounded-lg px-3 py-2 text-2xl text-white font-nova flex items-center drop-shadow-xl">
                                Next <span className='text-2xl ps-2'>&gt;</span>
                            </a>
                        </div>
                    </div>
