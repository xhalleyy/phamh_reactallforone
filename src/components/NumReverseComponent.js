...
import { numberReverseApi } from '../services/DataService.js';
  ...
  return (
    <div className='gameBG'>
        ...
        <div className="inline-block bg-customBlue2 ps-5 pe-9 py-1 mt-16 ms-16 rounded-md">
            <h1 className="font-hiromisake text-7xl text-white">Reverse It (Numeric)</h1>
        </div>
    </div>
      ...
      <div className="grid lg:grid-cols-2">
        <div className="lg:col-span-1 lg:ms-20 lg:mt-24 mt-10 ms-10">
            <p className="text-white font-nova lg:text-2xl text-xl pb-1" style={{lineHeight: '1.4rem'}}>Enter a sequence of <br/> numbers</p>
