...
import { oddOrEvenApi } from '../services/DataService.js';
        ...
        <div className='gameBG'>
            ...
            <div className="hidden lg:block">
                <div className="inline-block bg-customBlue2 ps-5 pe-9 py-1 mt-16 ms-16 rounded-md">
                    <h1 className="font-hiromisake text-7xl text-white">Odd or Even</h1>
                </div>
            </div>

            {/* RESPONSIVENESS TITLE */}
            <div className="block lg:hidden">
                <div className="inline-flex bg-customBlue2 ps-5 pe-9 py-1 mt-16 rounded-md">
                    <h1 className="font-hiromisake text-5xl md:text-6xl text-white">Odd or Even</h1>
                </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2">
                <div className="lg:col-span-1 lg:ms-20 lg:mt-24 mt-16 ms-10">
                    <p className="text-white font-nova lg:text-2xl text-xl">Enter a number</p>
                    <input onChange={(e) => setNumber(e.target.value)} id="numberinput" type="text" className="rounded-sm lg:text-2xl text-xl" />
                    <br />
